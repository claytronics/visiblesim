...
#ifdef verbose
        switch (currentStep) {
            case 1 : setColor(LIGHTBLUE); break;
            case 2 : setColor(LIGHTGREEN); break;
            case 3 : setColor(PINK); break;
        }
#endif // verbose
    }
    if (d<moduleDistance) {
...
// initial sender
                ...
                console << "C=" << module->blockId << "  diam=" << data.distanceMax << " to " << data.idMax << ">\n";
            }
        } else {
    ...
    if (electedChild!=UINT8_MAX) {
        ...
        switch (currentStep) {
            ...
            // calculate the distance to B
                console << "STEP 2: A=" << module->blockId << "\n";
                initModuleData();
                moduleDistance=0; /// distance of the master
                distance2ABC[1]=0;
                currentStep=2;
            ...
            // calculate the distance to C
                console << "STEP 3: B=" << module->blockId << "\n";
                initModuleData();
                moduleDistance=0; /// distance of the master
                distance2ABC[2]=0;
                currentStep=3;
